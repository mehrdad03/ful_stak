...
<li class="nav-item text-white {{@$rout_name=='client.profile.questions'?'active':''}}">
    <div class="d-flex align-items-center gap-2 pe-4">
        ...
        <a class="nav-link text-white fs-6" href="{{route('client.profile.dashboard')}}">داشبورد</a>
    </div>
</li>
<li class="nav-item text-white {{@$rout_name=='client.profile.my-courses'?'active':''}}">
    <div class="d-flex align-items-center gap-2 pe-4">
        <svg
            width="30"
            height="30"
        ...
        <a class="nav-link text-white fs-6" href="{{route('client.profile.my-courses')}}"
        >دوره های آموزشی</a
        >
    </div>
</li>
...
<li class="nav-item text-white">
    <div class="d-flex align-items-center gap-2 pe-4">
        ...
        <a class="nav-link text-white fs-6" href="{{route('client.logout')}}">خروج</a>
    </div>
</li>
